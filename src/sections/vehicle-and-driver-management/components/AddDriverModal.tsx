...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    subtitle: 'Register a new driver or import in bulk',
    ...
    driverAddedDesc: 'has been successfully added to your fleet.',
    done: 'Done',
    // Bulk upload
    ...
    requiredColumnsList: 'Full Name, Phone, DL Number, DL Expiry, Address, Assigned Vehicle (optional)',
    uploadAndImport: 'Upload & Import',
  },
  hi: {
    addDriver: 'ड्राइवर जोड़ें',
    subtitle: 'नया ड्राइवर पंजीकृत करें या बल्क में आयात करें',
    singleDriver: 'एकल ड्राइवर',
    ...
    driverAddedDesc: 'आपके बेड़े में सफलतापूर्वक जोड़ दिया गया है।',
    done: 'हो गया',
    // Bulk upload
    ...
    requiredColumnsList: 'पूरा नाम, फ़ोन, DL नंबर, DL समाप्ति, पता, सौंपा गया वाहन (वैकल्पिक)',
          ...
          <>
            <div className="relative px-6 py-10 flex flex-col items-center text-center">
              ...
              <p className="text-sm text-stone-500 dark:text-stone-400 mt-1.5">
                <span className="font-semibold text-stone-700 dark:text-stone-200">{addedDriver}</span>{' '}
                {t.driverAddedDesc}
              </p>
            </div>
